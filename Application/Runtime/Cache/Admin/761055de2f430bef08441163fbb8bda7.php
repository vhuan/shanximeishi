...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="/carshop1/Public/ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/carshop1/Public/ueditor/ueditor.all.min.js"> </script>
<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
<script type="text/javascript" charset="utf-8" src="/carshop1/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
</head>
<body>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop1/index.php/Admin/cate/lst">文章管理</a><span class="crumb-step">&gt;</span><span>修改文章</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <?php if($artres['pic'] != ''): ?><img src="/carshop1<?php echo ($artres["pic"]); ?>" height="50" /><?php else: ?>暂无缩略图<?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                                <th>内容：</th>
