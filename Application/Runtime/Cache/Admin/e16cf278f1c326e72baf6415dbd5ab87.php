...
<div class="container clearfix">
           ...
           <!--
            ...
            <?php endforeach;?>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="/carshop/index.php/Admin/Cate/lst"><i class="icon-font"></i>美食类别</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/cate/lst">文章管理</a><span class="crumb-step">&gt;</span><span>新增文章</span></div>
        </div>
